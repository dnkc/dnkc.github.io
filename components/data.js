...
export const projectsdata = [
  ...
  {
    type: "Front End",
    title: "(Functional) Spotify Clone",
    subtitle: "React, JavaScript, HTML, NextJS, Tailwind",
    description: "Hosted on Vercel.",
    image: spotifyclone,
...
export const experience = [
  {
    ...
    company: "Parsons",
    description: [
      "Fulfilled project plans in accordance with established scopes of work, budgets, and schedules to execute high quality projects",
      ...
      "Support Infrastructure Planning Studies including: Master Plans, Subwatershed Studies, Flooding Risk Assessments, and others as needed",
      "Design and assessment of erosion protection and sediment control measures",
