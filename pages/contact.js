...
const Contact = () => {
  ...
  return (
    <>
      ...
      <Navbar />
      <div className="bg-repeat w-full h-screen heropattern-ilikefood-red-200">
        <section className="body-font relative " id="contact">
          <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
            ...
            <div className="bg-primary-content text-lg text-primary lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0 theme:bg-secondary p-5 rounded-xl">
